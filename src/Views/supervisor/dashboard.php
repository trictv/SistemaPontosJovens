...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <a href="/supervisor/membros" class="text-lg font-bold text-blue-600 hover:underline">Membros (<?php echo count($membros); ?>) <i class="fas fa-external-link-alt text-sm"></i></a>
